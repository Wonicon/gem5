...
GEM5_DIR=~/Codes/gem5                          # Install location of gem5
SPEC_DIR=~/spec2006                  # Install location of your SPEC2006 benchmarks
##################################################################
...
RUN_DIR=$SPEC_DIR/benchspec/CPU2006/$BENCHMARK_CODE/run/run_base_ref_gcc43-64bit.0000     # Run directory for the selected SPEC benchmark
